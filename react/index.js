...
function (_Component) {
  ...
  function Carousel() {
    ...
    _defineProperty(_assertThisInitialized(_this), "componentDidMount", function () {
      _this.carousel = document && new _rescaleCarousel.default({
    ...
    var selectorID = Math.random().toString(36).substring(6);
    _this.state = {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(CarouselOuterWrapper, {
        className: "carousel-outer ".concat(className)
      }, typeof document !== 'undefined' && _react.default.createElement(_react.default.Fragment, null, prev && prev(this.prev), _react.default.createElement(CarouselWrapper, {
        className: "".concat(this.state.selector, " carousel-inner ").concat(className),
        width: width
      }, children), next && next(this.next)));
    }
  }]);
...
var CarouselWrapper = _styledComponents.default.div(_templateObject2(), function (_ref) {
